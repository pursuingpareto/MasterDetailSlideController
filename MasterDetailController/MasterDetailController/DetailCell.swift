...
class DetailCell: UIView {
    ...
    func commonInit() {
        ...
        var imageFrame = CGRect(origin: CGPoint(x: bounds.width * 0.05, y: bounds.height * 0.0), size: CGSize(width: bounds.width * 0.9, height: bounds.height * 0.8))
        ...
        descriptionLabel.frame = CGRect(origin: CGPoint(x: bounds.width * 0.05, y: bounds.height * 0.61), size: CGSize(width: bounds.width * 0.9, height: bounds.height * 0.4))
        descriptionLabel.numberOfLines = 7
        descriptionLabel.font = descriptionLabel.font.fontWithSize(9)
